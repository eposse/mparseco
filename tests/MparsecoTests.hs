...
prop1_tests = testGroup "first prop1" [ testProperty ("prop1 " ++ label) $ prop1 g | (label, g) <- generators ]

prop_seq_1_tests =
    testGroup "prop_seq_1" $
...
-- TODO: Add tests with ambiguous parsers

prop_tok_untok_tests =
    testGroup "prop_tok_untok_1"
